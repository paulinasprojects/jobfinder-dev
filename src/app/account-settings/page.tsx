...
import PersonalInformationForm from "@/components/personal-information-form";
  ...
  return (
    <motion.div 
      className="md:ml-[26px] lg:ml-0 md:mx-5 max-sm:ml-0"
    ...
    >
      ...
      <div className='xl:ml-20 mt-10 max-sm:ml-[26px] lg:ml-0'>
        <ImageComponent
          ...
          className2="lg:w-[850px] md:w-[650px] xl:w-[1280px]"
        />
      </div>
      <div className='flex xl:justify-between md:flex-col lg:flex-row lg:items-center max-sm:items-center lg:justify-normal lg:gap-10 md:gap-10 xl:gap-0'>
        <div className='flex flex-col xl:ml-[135px] mt-7 gap-2 max-sm:ml-[40px] lg:ml-[26px] md:ml-[26px]'>
          ...
          <div className='xl:flex gap-[18px] md:flex mb-12 max-sm:hidden lg:mr-24 lg:hidden md:ml-[26px] lg:ml-0'>
            <button className='text-neutralColor bg-[#F1F1F5] px-5 py-2 rounded-[10px] text-[15px] font-semibold hover:bg-greenButtonColor hover:text-white transition-all duration-300'>Cancel</button>
            <button className='text-white bg-greenButtonColor px-6 py-2 rounded-[10px] text-[15px] font-semibold hover:bg-white hover:text-greenButtonColor transition-all duration-300'>Save</button>
          </div>
      </div>
