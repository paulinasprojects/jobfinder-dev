  ...
  return (
    <div className="flex lg:flex-row  ml-20 mt-7 max-sm:flex-col max-sm:ml-15">
      <div className="relative">
          <SearchIcon color="#92929d" className="absolute top-7 left-3"/>
      ...
      <div className="relative">
        <MapPin color="#92929d" className="absolute top-7 left-2.5 max-sm:left-2"/>
      ...
      <div className="relative">
        <Briefcase color="#92929d" className="absolute top-7 left-2.5 max-sm:left-2"/>
