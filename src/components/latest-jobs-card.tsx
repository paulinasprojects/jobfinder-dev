        ...
        <CardContent>
          ...
          <div className='mt-6 flex justify-between items-center'>
           ...
           <Button 
              size="green" 
              color='#FFF' 
              className='text-white bg-greenButtonColor hover:bg-transparent hover:border-2 hover:border-greenButtonColor hover:text-greenButtonColor transition-all duration-300' 
