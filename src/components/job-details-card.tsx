  ...
  return (
    ...
    >
      <div className='md:ml-5 lg:ml-0'>
        <button className='max-sm:hidden md:flex p-2.5 bg-cardColorTwo  items-center gap-1.5 rounded-[10px] text-neutralColor text-xxs font-medium hover:bg-greenButtonColor hover:text-white transition-color' 
          ...
          <CardContent>
            <div className='flex lg:flex-row md:flex-col md:gap-5 lg:gap-0 justify-between  max-sm:flex-col max-sm:gap-4'>
              <div className='flex flex-col mt-8 ml-5 gap-1.5 max-sm:ml-0'>
                <button className='flex gap-[25px] items-center text-2xl font-bold text-white'>
                  React Developer 
                  <Bookmark className='text-neutralColor hover:text-greenButtonColor'/>
                </button>
              ...
              <div className='flex items-center gap-3.5 md:ml-3 lg:ml-0 max-sm:ml-0'>
                  <JobSearchApplyNowButton 
                    ...
                    onClick={() => router.push('/job/1/submit-your-application')}
                  />
            ...
            <div className='lg:flex max-sm:grid max-sm:grid-cols-160 max-sm:gap-[30px] md:grid md:grid-cols-3 md:gap-[30px] items-center justify-between px-4 py-5 mt-9 lg:ml-5 md:ml-5 bg-cardColorTwo  rounded-[20px] max-sm:ml-0'>
            ...
            <div className='mt-[60px] lg:ml-10 md:ml-5 flex flex-col gap-3 max-sm:ml-0'>
              ...
              >
                ...
                <button className='border border-greenButtonColor rounded-[10px] text-greenButtonColor flex items-center justify-center gap-1.5 p-1.5 text-xxs hover:bg-greenButtonColor hover:text-white transition-colors'>
                  <Plus width={18} height={18} className='cursor-pointer'/>
                  Follow
                </button>
              </div>
              <div className='mt-7'>
                <span className='text-neutralWhite200'>
                  UIHUT is a design and coding resources platform for designers, developers and entrepreneurs. 
                  We&apos;re building a digital marketplace to simplify the creation of websites, apps and software on any device. 
                  UIHUT is based in New York City and is privately funded by some of the industry&apos;s leading investors.
                </span>
              </div>
            </div>
          </CardContent>
