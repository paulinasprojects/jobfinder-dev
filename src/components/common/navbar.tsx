  ...
  return (
    <div className="flex items-center p-5 border-b border-b-cardColorTwo">
      ...
      <div className="ml-auto flex items-center gap-11 mr-9 max-sm:gap-6 max-sm:mr-0">
        <button className="w-[99px] h-[34px] rounded-[10px] text-greenButtonColor bg-[#122224] hover:bg-black hover:text-neutralWhite transition-colors" onClick={() => router.push("/add-job")}>Post Job</button>
